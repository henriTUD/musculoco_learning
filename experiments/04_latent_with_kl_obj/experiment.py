...
from musculoco_il.algorithms.GAIL_KL_objective import TargetEntropyUniform2NormalKLDGAIL, Uniform2NormalKLDGAIL, \
...
def build_agent(mdp, expert_data, use_cuda, discrim_obs_mask, train_D_n_th_epoch=3,
                ...
                std_a_0=1.0, std_x_0=1.0, action_divergence_coef=1e-3,
    ...
    if target_entropy_mode:
        alg_variant = TargetEntropyUniform2MultivariateGaussianKLDGAIL
        alg_params['target_entropy'] = target_entropy
    else:
        alg_variant = Uniform2MultivariateGaussianKLDGAIL

    agent = alg_variant(mdp_info=mdp_info, policy_class=LatentExplorationPolicy, policy_params=policy_params, sw=sw,
...
def experiment(n_epochs: int = 500,
    ...
    agent = build_agent(mdp=mdp, expert_data=expert_data, use_cuda=use_cuda,
                        ...
                        std_a_0=std_0, std_x_0=std_x_0, action_divergence_coef=action_divergence_coef,
                        target_entropy_mode=target_entropy_mode,

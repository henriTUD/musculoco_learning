...
def build_agent(mdp, expert_data, use_cuda, discrim_obs_mask, train_D_n_th_epoch=3,
                ...
                env_reward_frac=0.0, standardize_obs=True, target_entropy=0.0):
    ...
    agent = TargetEntropyGAIL(mdp_info=mdp_info, policy_class=OptionalGaussianTorchPolicy, policy_params=policy_params, sw=sw,
...
def experiment(n_epochs: int = 500,
    ...
    agent = build_agent(mdp=mdp, expert_data=expert_data, use_cuda=use_cuda,
                        ...
                        standardize_obs=standardize_obs, target_entropy=target_entropy)

...
from musculoco_il.policy.beta_distribution_torch_policy import BetaDistributionTorchPolicy, \
    MeanParameterizedBetaDistributionTorchPolicy
...
def build_agent(mdp, expert_data, use_cuda, discrim_obs_mask, train_D_n_th_epoch=3,
                ...
                env_reward_frac=0.0, standardize_obs=True, detach_mean=False,
                std_0=1.0, enforce_unimodal=True):
    ...
    policy_params = dict(network=FullyConnectedNetwork,
                         ...
                         raw_std_0=std_0,
                         enforce_unimodal=enforce_unimodal,
    ...
    agent = GAIL_TRPO(mdp_info=mdp_info, policy_class=MeanParameterizedBetaDistributionTorchPolicy, policy_params=policy_params, sw=sw,
...
def experiment(n_epochs: int = 500,
    ...
    agent = build_agent(mdp=mdp, expert_data=expert_data, use_cuda=use_cuda,
                        ...
                        standardize_obs=standardize_obs, std_0=std_0, enforce_unimodal=enforce_unimodal)
